  ...
  useEffect(() => {
    ...
    DoctorService.getById(id, true)
      .then((response) => {
        ...
        console.log("test", response.data.payload, "raw", raw)
        const transformedDoctor: Doctor = {
          ...
          schedule: {
            ...
            workDescription: (raw.schedule as any).scheduleWorkDescription,
          },
              ...
              <div className="h-full w-full rounded-lg bg-white px-8 py-2 lg:px-10 lg:py-4 3xl:px-12 3xl:py-8">
                <main className="flex flex-col gap-y-4">
                    ...
                    <div className="overflow-x-auto">
                      {appointments.length === 0 ? (
                        <div className="z-10 rounded-[20px] bg-white px-4 py-3 md:p-5 xl:p-6 2xl:p-7">
                          <NoData
                            width={200}
                            className="mx-auto w-[200px] p-7 xl:w-[300px]"
                          />
                  ...
                  <div className="my-4 flex w-full justify-end">
                    <button
                      type="button"
                      onClick={() => navigate(`/doctor/edit/${doctor._id}`)}
