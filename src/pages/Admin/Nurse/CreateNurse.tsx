...
const NurseCreate = () => {
  ...
  const createNurse = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || 'Failed to create nurse. Please try again.'
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="h-full w-full rounded-lg bg-white px-8 py-2 lg:px-10 lg:py-4 3xl:px-12 3xl:py-6">
            <form className="flex flex-col gap-y-6">
              ...
              <div className="flex w-full flex-col items-start justify-center">
                <label htmlFor="nurse-name" className="mb-2 w-full">
              ...
              {/* Specialization */}
              <div className="flex w-full flex-col items-start justify-center">
                <label htmlFor="nurse-specialization" className="mb-2 w-full">
                  <p className="w-full text-sm font-semibold lg:text-base 3xl:text-xl">
                    Specialization
                  </p>
                </label>
                <input
                  ...
                  placeholder="Enter nurse's specialization"
              ...
              <div className="flex w-full flex-col items-start justify-center gap-y-4">
                ...
                <div className="flex w-full flex-col">
                  ...
                  <div className="flex gap-x-4">
                    <div className="flex flex-col">
                      <label htmlFor="nurse-schedule-start" className="text-xs">
                        Start Time
                      </label>
                      <input
                        id="nurse-schedule-start"
                        type="time"
                        step="1"
                    ...
                    <div className="flex flex-col">
                      <label htmlFor="nurse-schedule-end" className="text-xs">
                        End Time
                      </label>
                      <input
                        id="nurse-schedule-end"
                        type="time"
                        step="1"
                    ...
                    {weekdays.map((day) => (
                      <div key={day} className="flex items-center">
                        <input
                          ...
                          className="mr-1"
                        />
                        <label htmlFor={`nurse-day-${day}`} className="text-xs">
                          {day}
                        </label>
                      </div>
                    ))}
                ...
                {/* Work Description */}
                <div className="flex w-full flex-col items-start justify-center">
                  <label htmlFor="nurse-schedule-work-description" className="mb-2 w-full">
                    <p className="w-full text-sm font-semibold lg:text-base 3xl:text-xl">
                      Work Description
                    </p>
                  </label>
                  <textarea
                    id="nurse-schedule-work-description"
                    className="flex w-full rounded-lg border border-[#CCC] p-1 text-xs font-medium lg:p-3 lg:text-sm 3xl:p-5 3xl:text-base"
