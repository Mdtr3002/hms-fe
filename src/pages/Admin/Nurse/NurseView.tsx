          ...
          {loading ? (
            <>
              ...
              <p className="w-full px-6 lg:px-8 3xl:px-10">
                <Skeleton count={10} className="my-2 lg:my-4 3xl:my-6" width="100%" height={40} baseColor="#9DCCFF" />
              </p>
            </>
          ) : (
            <div className="h-full w-full rounded-lg bg-white px-8 py-2 lg:px-10 lg:py-4 3xl:px-12 3xl:py-8">
              <main className="flex flex-col gap-y-4">
                ...
                <div className="flex flex-col gap-y-1">
                  <label className="text-base lg:text-lg 3xl:text-xl" htmlFor="nurse-specialization">
                    Specialization
                  </label>
                  <input
